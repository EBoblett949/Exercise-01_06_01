    ...
    // Funcation to  remove select list defaults
    ...
    // function to set up document fragements for days of the month
    function setUpDays() {
    ...
    function validateMessage() {
        ...
        try {
            // validate checkbox and custom text message
    ...
    // function to creat our event listeners 
